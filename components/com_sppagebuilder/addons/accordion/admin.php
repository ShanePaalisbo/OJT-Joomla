...
array(
	...
	'attr'=>array(
		'general' => array(
			...
			'style'=>array(
				'type'=>'select',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_STYLE'),
			...
			'item_separator'=>array(
				'type'=>'separator',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_STYLE_OPTIONS'),
				'depends'=> array(
			...
			'item_bg'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_BG'),
				'std'=>'',
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			...
			'item_border_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_BORDER_COLOR'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'item_border_width'=>array(
				'type'=>'margin',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_BORDER_WIDTH'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'item_border_radius'=>array(
				'type'=>'slider',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_BORDER_RADIUS'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
				'max'=>1000,
			...
			'title_separator'=>array(
				'type'=>'separator',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_TITLE_STYLE_OPTION'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'item_title_bg_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_TITLE_BG_COLOR'),
				'std'=>'',
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			...
			'item_title_lineheight'=>array(
				'type'=>'slider',
				'title'=>Text::_('COM_SPPAGEBUILDER_GLOBAL_TITLE_LINE_HEIGHT'),
				'std'=>'',
				'responsive' => true,
				'max'=> 400,
				'depends'=> array(
			...
			'icon_separator'=>array(
				'type'=>'separator',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ICON_STYLE_OPTIONS'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'item_content_padding'=>array(
				'type'=>'padding',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_CONTENT_PADDING'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
				'responsive'=>true,
			...
			'item_content_border_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_CONTENT_BORDER_COLOR'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'item_content_border_width'=>array(
				'type'=>'margin',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_CONTENT_BORDER'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'active_separator'=>array(
				'type'=>'separator',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ACTIVE_STYLE_OPTIONS'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
			...
			'active_title_bg_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ITEM_ACTIVE_TITLE_BG_COLOR'),
				'std'=>'',
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			...
			'active_title_text_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ACTIVE_TITLE_TEXT_COLOR'),
				'std'=>'',
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			...
			'active_icon_color'=>array(
				'type'=>'color',
				'title'=>Text::_('COM_SPPAGEBUILDER_ADDON_ACCORDION_ACTIVE_ICON_COLOR'),
				'depends'=> array(
					array('style', '=', 'panel-custom'),
				),
			),
